...
namespace VLib.Args.Binding
{
    ...
    public sealed class OptionModel
    {
        ...
        /// <summary>
        /// Finds a parameter by <paramref name="name"/>. If not found, throws a <see cref="VLibArgException"/> with a suggestion.
        /// </summary>
        /// 
        /// <param name="name">
        /// The name of the parameter to search for.
        ...
        /// </returns>
        /// 
        /// <exception cref="VLibArgException"></exception>
        public OptionDescriptor Find(string name)
        {
            ...
            throw new VLibArgException($"Nincs '{name}' nevű paraméter.", SuggestName(name));
        }
        ...
        private string? SuggestName(string name)
        {
            ...
            return close.Count > 0
                ? $"Esetleg ezekre gondoltál: {string.Join(", ", close)}"
                : "A teljes listához: 'help param'";
        }
