...
namespace VLib.Args.Parsing.Builtin
{
    ...
    {
        /// <inheritdoc />
        public override string TypeName => "szám";
        ...
        protected override ParseResult ParseCore(string text)
        {
            ...
            return ParseResult.Fail($"a(z) '{text}' nem érvényes szám.");
        }

        /// <inheritdoc />
        public override string Format(object? value)
        {
            return value is double d ? d.ToString("0.####", CultureInfo.InvariantCulture) : "(nincs)";
        }
    }
}
