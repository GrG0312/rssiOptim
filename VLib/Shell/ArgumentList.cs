...
namespace VLib.Args.Shell
{
    ...
    public sealed class ArgumentList : IReadOnlyList<string>
    {
        ...
        /// <summary>
        /// Returns the argument at the specified index, or throws a <see cref="VLibArgException"/> if the index is out of range.
        /// </summary>
        ///
        /// <param name="index">
        ...
        public string Require(int index, string name, string? usage = null)
        {
            ...
            if (value is null)
            {
                throw new VLibArgException($"Hiányzik: {name}.", usage);
            }
            return value;
        }
